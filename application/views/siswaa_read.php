          ...
          <div class='row'>
            <div class='col-xs-12'>
              <div class='box'>
                ...
                <h3 class='box-title'>Siswaa Read</h3>
	    ...
	    <tr><td>Id Universitas</td><td><?php echo $id_universitas; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('siswaa') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
