                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown use-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding-right: 30px;">                                    
                                    <span class="hidden-xs">Petugas &nbsp <i class="fa fa-power-off" aria-hidden="true"></i></span>
                                </a>
           ...
           <aside class="main-sidebar">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo site_url('petugasppm/jurusan') ?>"><i class="fa fa-graduation-cap"></i>PROGRAM STUDI</a></li>
                    <li><a href="<?php echo site_url('petugasppm/fakultas') ?>"><i class="fa fa-graduation-cap"></i>FAKULTAS</a></li>
                    <li><a href="<?php echo site_url('petugasppm/universitas') ?>"><i class="fa fa-graduation-cap"></i> UNIVERSITAS</a></li>
                    <li><a href="<?php echo site_url('petugasppm/kelas') ?>"><i class="fa fa-graduation-cap"></i>KELAS</a></li>
                </ul>
            </li>
            <li>
                <a href="<?php echo site_url('petugasppm/Siswa') ?>">
                    <i class="fa fa-users"></i> <span>DAFTAR SANTRI</span>
                </a>
            </li>
            <li>
                <a href="<?php echo site_url('petugasppm/guru') ?>">
        ...
        <li>
            ...
            <div class="content-wrapper">
                ...
                <section>
                    ...
                    <center><h2 style="margin-left: -8%"> &nbspAnda login sebagai petugas<br>
                    <strong> PPM Yogyakarta!</strong></h2></center>
