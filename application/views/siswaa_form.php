<!-- Main content -->
	    ...
	    <tr><td>Umur <?php echo form_error('umur') ?></td>
            <td><input type="text" class="form-control" name="umur" id="umur" placeholder="Umur" value="<?php echo $umur; ?>" />
        </td>
	    <tr><td>Jenis Kelamnin <?php echo form_error('jenis_kelamnin') ?></td>
            <td><input type="text" class="form-control" name="jenis_kelamnin" id="jenis_kelamnin" placeholder="Jenis Kelamnin" value="<?php echo $jenis_kelamnin; ?>" />
        </td>
	    <tr><td>Golongan Darah <?php echo form_error('golongan_darah') ?></td>
            <td><input type="text" class="form-control" name="golongan_darah" id="golongan_darah" placeholder="Golongan Darah" value="<?php echo $golongan_darah; ?>" />
        </td>
	    ...
	    <tr><td>Id Fakultas <?php echo form_error('id_fakultas') ?></td>
            <td><input type="text" class="form-control" name="id_fakultas" id="id_fakultas" placeholder="Id Fakultas" value="<?php echo $id_fakultas; ?>" />
        </td>
	    ...
	    <tr><td>Angkatan Universitas <?php echo form_error('angkatan_universitas') ?></td>
            <td><input type="text" class="form-control" name="angkatan_universitas" id="angkatan_universitas" placeholder="Angkatan Universitas" value="<?php echo $angkatan_universitas; ?>" />
        </td>
	    <tr><td>Tahun Masuk Universitas <?php echo form_error('tahun_masuk_universitas') ?></td>
            <td><input type="text" class="form-control" name="tahun_masuk_universitas" id="tahun_masuk_universitas" placeholder="Tahun Masuk Universitas" value="<?php echo $tahun_masuk_universitas; ?>" />
        </td>
	    <tr><td>Angkatan Ppm <?php echo form_error('angkatan_ppm') ?></td>
            <td><input type="text" class="form-control" name="angkatan_ppm" id="angkatan_ppm" placeholder="Angkatan Ppm" value="<?php echo $angkatan_ppm; ?>" />
        </td>
	    <tr><td>Tahun Masuk Ppm <?php echo form_error('tahun_masuk_ppm') ?></td>
            <td><input type="text" class="form-control" name="tahun_masuk_ppm" id="tahun_masuk_ppm" placeholder="Tahun Masuk Ppm" value="<?php echo $tahun_masuk_ppm; ?>" />
        </td>
	    ...
	    <a href="<?php echo site_url('siswaa') ?>" class="btn btn-default">Cancel</a></td></tr>
