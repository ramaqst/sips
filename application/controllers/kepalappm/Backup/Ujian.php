...
class Ujian extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('petugasppm/Ujian_model');
    ...
    public function index()
    {
        ...
        $this->template->load('petugasppm/v_petugas','petugasppm/ujian_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nilai' => $row->nilai,
            ...
            $this->template->load('petugasppm/v_petugas','petugasppm/ujian_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('petugasppm/ujian'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('petugasppm/ujian/create_action'),
        ...
        $this->template->load('petugasppm/v_petugas','petugasppm/ujian_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Ubah',
                'action' => site_url('petugasppm/ujian/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('petugasppm/ujian_doc',$data);
    }
