...
class Guru extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('kepalappm/Guru_model');
    ...
    public function index()
    {
        ...
        $this->template->load('kepalappm/v_kepala','kepalappm/guru_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'kelas' => $row->kelas,
            ...
            $this->template->load('kepalappm/v_kepala','kepalappm/guru_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('kepalappm/guru'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('kepalappm/guru/create_action'),	    
        ...
        $this->template->load('kepalappm/v_kepala','kepalappm/guru_form', $data);
    }
    ...
    public function create_action() 
    {
		...
		'id_kelas' => $this->input->post('id_kelas',TRUE),
            ...
            $this->load->model('kepalappm/nomorinduk_model','nim');
            ...
            redirect(site_url('kepalappm/guru'));
        $this->load->view('kepalappm/guru_list');
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Ubah',
                'action' => site_url('kepalappm/guru/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('kepalappm/guru_doc',$data);
    }
