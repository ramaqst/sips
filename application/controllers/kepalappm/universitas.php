...
class Universitas extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('petugasppm/Universitas_model');
    ...
    public function index()
    {
        ...
        $this->template->load('petugasppm/v_petugas','petugasppm/universitas_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'universitas' => $row->universitas,
            ...
            $this->template->load('petugasppm/v_petugas','petugasppm/universitas_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('petugasppm/universitas'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('petugasppm/universitas/create_action'),
	    'id_universitas' => set_value('id_universitas'),
	    'universitas' => set_value('universitas'),
	);
        $this->template->load('petugasppm/v_petugas','petugasppm/universitas_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Ubah',
                'action' => site_url('petugasppm/universitas/update_action'),
