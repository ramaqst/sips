...
class Siswa extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('kepalappm/Siswa_model');
    ...
    public function index()
    {
        ...
        $this->template->load('kepalappm/v_kepala','kepalappm/siswa_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'id_kelas' => $row->kelas,
            ...
            $this->template->load('kepalappm/v_kepala','kepalappm/siswa_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('kepalappm/siswa'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Tambah',
            'action' => site_url('kepalappm/siswa/create_action'),
        ...
        $this->template->load('kepalappm/v_kepala','kepalappm/siswa_form', $data);
    }
    ...
    public function create_action() 
    {
    	...
    	$this->load->view('kepalappm/siswa_list');
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Ubah',
                'action' => site_url('kepalappm/siswa/update_action'),
