        ...
        <div class="box-body">
          <div class="btn-group">
            <?php foreach ($uas as $row): ?>
              <a href="<?= base_url('kepalappm/grafik/uas/'.$row->id_uas) ?>" class="btn btn-primary"><?= $row->uas ?></a>
            <?php endforeach ?>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-6">
      <div class="box box-primary text-center">
        ...
        <div class="box-body">
          <div class="btn-group">
            <?php foreach ($uas as $row): ?>
              <a href="<?= base_url('kepalappm/grafik/kelas/'.$row->id_uas) ?>" class="btn btn-primary"><?= $row->uas ?></a>
            <?php endforeach ?>
          </div>
        </div>
      </div>
