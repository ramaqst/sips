<!-- Main content -->
	    ...
	    <tr><td class="col-sm-3 control-label">Nama Jurusan <?php echo form_error('petugasppm/jurusan') ?></td>
	    ...
	    <a href="<?php echo site_url('petugasppm/jurusan') ?>" class="btn btn-danger">Batal</a></td></tr>
