<!-- Main content -->
	    ...
	    <tr><td class="col-sm-3 control-label">Perguruan Tinggi <?php echo form_error('petugasppm/universitas') ?></td>
	    ...
	    <a href="<?php echo site_url('petugasppm/universitas') ?>" class="btn btn-danger">Batal</a></td></tr>
