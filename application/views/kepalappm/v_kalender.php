              ...
              <tbody>
                ...
                <?php else: ?>
                  <?php foreach ($data as $agenda): ?>
                    <tr>
                      <td><a href="<?= base_url('kepalappm/kalender/edit/'.$agenda['id'])?>"><?= $agenda['title']?></a></td>
                      <td><?= $agenda['start']?></td>
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <a href="<?= base_url('kepalappm/kalender/delete/'.$agenda['id'])?>" class="btn btn-danger">Hapus</a>
                          </div>
                        </div>
                      </div>
                    </div>
